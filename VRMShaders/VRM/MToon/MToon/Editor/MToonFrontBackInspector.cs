...
namespace MToon
{
    public class MToonFrontBackInspector : ShaderGUI
    {
        ...
        private MaterialProperty _backColor;
        ...
        private MaterialProperty _backMainTex;
        ...
        private MaterialProperty _backShadeColor;
        private MaterialProperty _shadeShift;
        private MaterialProperty _shadeTexture;
        private MaterialProperty _backShadeTexture;
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            _backColor = FindProperty("_BackColor", properties);
            _shadeColor = FindProperty(Utils.PropShadeColor, properties);
            _backShadeColor = FindProperty("_BackShadeColor", properties);
            _mainTex = FindProperty(Utils.PropMainTex, properties);
            _backMainTex = FindProperty("_BackMainTex", properties);
            _shadeTexture = FindProperty(Utils.PropShadeTexture, properties);
            _backShadeTexture = FindProperty("_BackShadeTexture", properties);
        ...
        private void Draw(MaterialEditor materialEditor, Material[] materials)
        {
            EditorGUI.BeginChangeCheck();
            {
                ...
                EditorGUILayout.BeginVertical(GUI.skin.box);
                {
                    ...
                    {
                        materialEditor.TexturePropertySingleLine(new GUIContent("Front Lit Color, Alpha", "Lit (RGB), Alpha (A)"), _mainTex, _color);
                        materialEditor.TexturePropertySingleLine(new GUIContent("Front Shade Color", "Shade (RGB)"), _shadeTexture, _shadeColor);
                        materialEditor.TexturePropertySingleLine(new GUIContent("Back Lit Color, Alpha", "Lit (RGB), Alpha (A)"), _backMainTex, _backColor);
                        materialEditor.TexturePropertySingleLine(new GUIContent("Back Shade Color", "Shade (RGB)"), _backShadeTexture, _backShadeColor);
                    }
