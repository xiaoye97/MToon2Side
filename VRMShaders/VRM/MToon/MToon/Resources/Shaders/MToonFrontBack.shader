Shader "VRM/MToonFrontBack"
{
    Properties
    {
        _Cutoff ("Alpha Cutoff", Range(0, 1)) = 0.5
        _Color ("Front Lit Color + Alpha", Color) = (1,1,1,1)
        _BackColor ("Back Lit Color + Alpha", Color) = (1,1,1,1)
        _ShadeColor ("Front Shade Color", Color) = (0.97, 0.81, 0.86, 1)
        _BackShadeColor ("Back Shade Color", Color) = (0.97, 0.81, 0.86, 1)
        [NoScaleOffset] _MainTex ("Front Lit Texture + Alpha", 2D) = "white" {}
        [NoScaleOffset] _ShadeTexture ("Front Shade Texture", 2D) = "white" {}
        [NoScaleOffset] _BackMainTex ("Front Lit Texture + Alpha", 2D) = "white" {}
        [NoScaleOffset] _BackShadeTexture ("Front Shade Texture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "./MToonFrontBackSM3.cginc"
            #pragma vertex vert_forward_base
            #pragma fragment back_frag_forward
...
//            #pragma multi_compile_instancing
    ...
    CustomEditor "MToon.MToonFrontBackInspector"
}
